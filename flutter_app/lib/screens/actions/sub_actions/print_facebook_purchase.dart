...
class PrintFacebookPurchase extends StatefulWidget {
  const PrintFacebookPurchase({super.key});

  @override
  State<PrintFacebookPurchase> createState() => _State();
}

class _State extends State<PrintFacebookPurchase> {
  ...
  Future<void> _printReport() async {
    ...
    final report = await AppController.reportController.getSalesReport(start, end, true, isQuran);

    await PdfService.generateReport(
      title: 'كشف مبيعات الفيس بوك',
      rows: report.rows,
      total: report.total,
